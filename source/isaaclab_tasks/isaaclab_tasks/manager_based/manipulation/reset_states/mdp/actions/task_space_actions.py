...
class PreprocessedOperationalSpaceControllerAction(OperationalSpaceControllerAction):
    ...
    cfg: actions_cfg.PreprocessedOperationalSpaceControllerActionCfg
    """The configuration of the action term."""

    def __init__(self, cfg: actions_cfg.PreprocessedOperationalSpaceControllerActionCfg, env: ManagerBasedEnv):
    ...
    def process_actions(self, actions: torch.Tensor):
        ...
        self._preprocessed_actions[:] = scaled_actions_offset_coords
